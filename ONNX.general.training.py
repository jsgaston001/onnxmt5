...
for symbol in symbols:
        ...
        # input parameters
        inp_model_name = "model." +str(symbol) +"."+"H1.700.onnx"
        inp_history_size = 700
        ...
        history = model.fit(x_train, y_train, epochs = 400 , validation_data = (x_test,y_test), batch_size=32, verbose=2)
